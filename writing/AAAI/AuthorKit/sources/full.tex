...
\usepackage{amsmath}
\graphicspath{ {/afs/inf.ed.ac.uk/user/s09/s0954584/Dropbox/4th/Poker/} }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{pos.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{potVar.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{raisePotVar.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{flopStrength.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{noRaises.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{avgPreRaise.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{handVar.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{histAmmWon.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{ig8_200.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{rocNorm8.jpg}
    \caption{The ROC curves obtained by running a decision tree algorithm using the 8 aforementioned features.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{convergence8.jpg}
    \caption{The convergence rate of the \emph{Area Under Curve} as the amount of data used grows from 1\% to 100\%.}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth,natwidth=610,natheight=642]{smallConv8.jpg}
...
\bibitem[\protect\citeauthoryear{Billings \bgroup et al\mbox.\egroup
  }{2003}]{P11}
...
\bibitem[\protect\citeauthoryear{Dahl}{2001}]{P13}
Dahl, F.
\newblock 2001.
...
\bibitem[\protect\citeauthoryear{Davidson}{2002}]{P7}
Davidson, A.
\newblock 2002.
...
\bibitem[\protect\citeauthoryear{Johanson and Bowling}{2009}]{P5}
...
\bibitem[\protect\citeauthoryear{Johanson, Zinkevich, and Bowling}{2007}]{P2}
Johanson, M.; Zinkevich, M.; and Bowling, M.
\newblock 2007.
\newblock Computing robust counter-strategies.
\newblock {\em Advances in neural information processing systems} 20:721--728.

\bibitem[\protect\citeauthoryear{Johanson}{2007}]{P3}
Johanson, M.
\newblock 2007.
...
\bibitem[\protect\citeauthoryear{Koller and Pfeffer}{1997}]{P12}
Koller, D., and Pfeffer, A.
\newblock 1997.
\newblock Representations and solutions for game-theoretic problems.
\newblock {\em Artificial Intelligence} 94(1):167--215.

\bibitem[\protect\citeauthoryear{Kullback and Leibler}{1951}]{P14}
Kullback, S., and Leibler, R.
\newblock 1951.
\newblock On information and sufficiency.
\newblock {\em The Annals of Mathematical Statistics} 22(1):79--86.

\bibitem[\protect\citeauthoryear{Maîtrepierre, Mary, and Munos}{2008}]{P10}
...
\bibitem[\protect\citeauthoryear{McCurley}{2009}]{P9}
McCurley, P.
\newblock 2009.
...
\bibitem[\protect\citeauthoryear{Rubin and Watson}{2011}]{P1}
Rubin, J., and Watson, I.
\newblock 2011.
\newblock Computer poker: A review.
\newblock {\em Artificial Intelligence} 175(5):958--987.

\bibitem[\protect\citeauthoryear{Schauenberg}{2006}]{P8}
Schauenberg, T.
\newblock 2006.
\newblock Opponent modelling and search in poker.
\newblock Master's thesis, University of Alberta, Canada.

\bibitem[\protect\citeauthoryear{Shi and Littman}{2001}]{P4}
Shi, J., and Littman, M.
\newblock 2001.
