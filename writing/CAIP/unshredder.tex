...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \setlength{\abovecaptionskip}{1pt plus 1.0pt minus 2.0pt}
        \centering
        \includegraphics[width=\textwidth]{rowComp300.jpg}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{searchComp300.jpg}
        \caption{Performance comparison.}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{searchTimeComp300.jpg}
...
\begin{figure}[t]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{searchRed300.jpg}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{cascadingComp300.jpg}
...
\begin{figure}[t]
    ...
    \begin{minipage}[b]{0.44\textwidth}
        \begin{subfigure}[b]{\textwidth}
          \includegraphics[width=\textwidth]{innerOuterRows.png}
     ...
     \end{minipage}
      \hfill
    \begin{subfigure}[b]{0.48\textwidth}
        \includegraphics[width=\textwidth]{rowOrient300.jpg}
