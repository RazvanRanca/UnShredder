...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{searchScores}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{searchGroups}
  \caption{The proportion of correct edges found by each search heuristic as the number of shreds increases.}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{searchTime}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{cascadingCorrection}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{errorCorrecting}
